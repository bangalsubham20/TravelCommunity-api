...
import com.wravelcommunity.service.TripService;
...
public class TripController {
    ...
    public ResponseEntity<List<Trip>> getAllTrips(
        ...
        return ResponseEntity.ok(tripService.getAllTrips(minPrice, maxPrice, difficulty, destination, season, search, sortBy));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateTrip(@PathVariable Long id, @RequestBody Trip trip, @RequestHeader("Authorization") String token) {
        try {
