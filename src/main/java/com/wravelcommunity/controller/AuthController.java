...
import com.wravelcommunity.service.AuthService;
...
public class AuthController {
    ...
    @PutMapping("/profile")
    public ResponseEntity<?> updateProfile(@RequestHeader("Authorization") String token, @RequestBody UserUpdateRequest request) {
        try {
